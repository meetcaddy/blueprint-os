...
<references>
@../../../skillsmith-specs/entry-point.md (when assessing entry point compliance)
@../../../skillsmith-specs/tasks.md (when assessing task files)
@../../../skillsmith-specs/templates.md (when assessing template files)
@../../../skillsmith-specs/frameworks.md (when assessing framework files)
@../../../skillsmith-specs/context.md (when assessing context files)
@../../../skillsmith-specs/checklists.md (when assessing checklist files)
@../../../skillsmith-specs/rules.md (when assessing rules files)
</references>
...
Load @../../../skillsmith-specs/entry-point.md and check the entry point file against it.
...
1. Load the corresponding spec from `@../../../skillsmith-specs/{folder-type}.md`
