...
<references>
@../../../skillsmith-specs/entry-point.md (when generating entry point)
@../../../skillsmith-specs/tasks.md (when generating task files)
@../../../skillsmith-specs/templates.md (when generating template files)
@../../../skillsmith-specs/frameworks.md (when generating framework files)
@../../../skillsmith-specs/context.md (when generating context files)
@../../../skillsmith-specs/checklists.md (when generating checklist files)
