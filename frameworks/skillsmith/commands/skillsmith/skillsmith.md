...
## Load on Demand
@../../skillsmith-specs/entry-point.md (when referencing entry point conventions)
@../../skillsmith-specs/tasks.md (when referencing task conventions)
@../../skillsmith-specs/templates.md (when referencing template conventions)
@../../skillsmith-specs/frameworks.md (when referencing framework conventions)
@../../skillsmith-specs/context.md (when referencing context conventions)
@../../skillsmith-specs/checklists.md (when referencing checklist conventions)
@../../skillsmith-specs/rules.md (when referencing rules conventions)
</routing>
