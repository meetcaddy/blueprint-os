...
**Phase type:** [Optional. Reference a phase type from `~/.claude/paul-framework/phase-types/{dev,marketing-and-ops}/{name}-phase.md` if this phase fits a known category. Examples: `secure-phase`, `ai-integration-phase`, `campaign-phase`, `customer-lifecycle-phase`. Omit if this phase is bespoke.]
**Risk:** [Low | Medium | High], [one-line rationale: what's at stake if this phase fails or gets it wrong]
...
**Plans:**
- [ ] 01-01: [Brief description], Risk: [Low | Medium | High]
- [ ] 01-02: [Brief description], Risk: [Low | Medium | High]
- [ ] 01-03: [Brief description], Risk: [Low | Medium | High]

### Phase 2: [Name]

**Goal:** [What this phase delivers]
**Depends on:** Phase 1 ([specific dependency])
**Phase type:** [Optional, see Phase 1 example]
...
**Depends on:** Phase 2
**Phase type:** [Optional, usually omitted for inserted phases]
**Risk:** [Low | Medium | High], [one-line rationale; inserted phases often carry higher risk because scope was unplanned]
**Reason:** [Why this was inserted]

**Plans:**
- [ ] 02.1-01: [Description], Risk: [Low | Medium | High]
...
**Plans:**
- [ ] 03-01: [Brief description], Risk: [Low | Medium | High]
- [ ] 03-02: [Brief description], Risk: [Low | Medium | High]
...
**Plans:**
- [ ] 04-01: [Brief description], Risk: [Low | Medium | High]
