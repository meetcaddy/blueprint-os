...
risk: medium                     # low | medium | high, what's at stake if this plan fails or gets it wrong
risk_rationale: ""               # one-line: why this risk level (e.g., "touches auth flow", "throwaway exploration", "irreversible schema change")
---
